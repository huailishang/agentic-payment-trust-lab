...
SNAPSHOT = EVIDENCE / "EV-07-task-snapshot.txt"
TASK_PATHS = [
    Path("CURRENT.md"),
    ...
    Path("tests/test_webshop_unknown_payment_authoritative_trace.py"),
    Path("tests/test_project_impact_baseline.py"),
    Path("docs/05_任务交接/P9_PRODUCT_AUTHORITATIVE_TRACE_T09_UNKNOWN_PAYMENT_RECOVERY_SLICE_V1/CONTRACT.md"),
]
