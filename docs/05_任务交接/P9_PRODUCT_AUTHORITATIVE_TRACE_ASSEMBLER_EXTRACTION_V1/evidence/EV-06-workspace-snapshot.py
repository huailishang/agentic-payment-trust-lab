...
TASK_PATHS = [
    ...
    Path("src/agentic_payment_experiment/webshop_authoritative_trace.py"),
    Path("src/agentic_payment_experiment/webshop_happy_path_authoritative_trace.py"),
    Path("tests/test_webshop_trace_assembler.py"),
    Path("docs/05_任务交接/P9_PRODUCT_AUTHORITATIVE_TRACE_ASSEMBLER_EXTRACTION_V1/CONTRACT.md"),
]
